{
    ...
    for (counter = 0, counterTwo = 0, counterThree = 0; counter < 980; counter += 20, counterTwo += 40, counterThree += 60) {
        createRect(baseValue, -35 - counterTwo, 50, 8, "transparent", "#C60139", ctx, rectArrLaneTwo);
        createRect(baseValue + 20, -35 - counterThree, 70, 8, "transparent", "#FFC300", ctx, rectArrLaneThree);
        createRect(baseValue + 40, -35 - counterTwo, 50, 8, "transparent", "#C60139", ctx, rectArrLaneFour);
        createRect(baseValue + 80, -35 - counterThree, 70, 8, "transparent", "#571845", ctx, rectArrLaneEleven);
        createRect(baseValue + 120, -35 - counterTwo, 50, 8, "transparent", "#C60139", ctx, rectArrLaneSeven);
        createRect(baseValue + 140, -35 - counterThree, 70, 8, "transparent", "#FFC300", ctx, rectArrLaneEight);
        createRect(baseValue + 160, -35 - counterTwo, 50, 8, "transparent", "#C60139", ctx, rectArrLaneNine);

        createRect(baseValue, -35 - counterTwo, 50, 8, "transparent", "#C60139", ctxTwo, rectArrLaneThirteen);
        createRect(baseValue + 20, -35 - counterThree, 70, 8, "transparent", "#FFC300", ctxTwo, rectArrLaneFourteen);
        createRect(baseValue + 40, -35 - counterTwo, 50, 8, "transparent", "#C60139", ctxTwo, rectArrLaneFifteen);
        createRect(baseValue + 80, -35 - counterThree, 70, 8, "transparent", "#571845", ctxTwo, rectArrLaneSeventeen);
        createRect(baseValue + 120, -35 - counterTwo, 50, 8, "transparent", "#C60139", ctxTwo, rectArrLaneNineteen);
        createRect(baseValue + 140, -35 - counterThree, 70, 8, "transparent", "#FFC300", ctxTwo, rectArrLaneTwenty);
        createRect(baseValue + 160, -35 - counterTwo, 50, 8, "transparent", "#C60139", ctxTwo, rectArrLaneTwentyOne);
    }
    function mainLoop() {
